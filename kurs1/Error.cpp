...
Error::ERROR errors[ERROR_MAX_ENTRY] =
{
	...
	ERROR_ENTRY(131, "[Лексическая] Превышено значение символьного литерала"),
	...
	ERROR_ENTRY(309, "[Cемантическая] Недопустимое значение переменной типа UNUMBER"),
	...
	ERROR_ENTRY(312, "[Cемантическая] Недопустимое значение переменной типа NUMBER"),
	ERROR_ENTRY(313, "[Cемантическая] Недопустимое значение переменной типа UNUMBER"),

...
char Lex::GetToken(std::string str) {
	std::array<std::string, 32> regexps = {
		REG_CREATE, REG_SYMBOL, REG_STRING, REG_NUMBER, REG_FUNCTION, REG_RETURN, REG_SHOW,
	...
	std::array<char, 32> tokens = {
		LEX_CREATE, LEX_SYMBOL, LEX_STRING, LEX_NUMBER, LEX_FUNCTION, LEX_RETURN, LEX_SHOW,
